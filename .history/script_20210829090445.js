$(function() {
    var playerTrack = $("#player-track"),
        ...
        buffInterval = null,
        tFlag = false,
        albums = ['Nơi này có anh', 'Bỏ em vào balo', 'Sai cách yêu', 'Một bước yêu vạn dặm đau', 'Nắm lấy tay anh'],
        trackNames = ['Sơn Tùng MTP', 'Tân Trần', 'Lê Bảo Bình', 'Mr.Siro', 'Tuấn Hưng'],
        albumArtworks = ['_1', '_2', '_3', '_4', '_5'],
        trackUrl = ['./Musics/noi_nay_co_anh.mp3', './Musics/Bo_em_vao_balo.mp3', './Musics/sai_cach_yeu.mp3', './Musics/Mot_Buoc_Yeu_Van_Dam_Dau.mp3', './Musics/Nam_Lay_Tay_Anh.mp3', '', ],
