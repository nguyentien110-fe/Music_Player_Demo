$(function() {
    var playerTrack = $("#player-track"),
        ...
        buffInterval = null,
        tFlag = false,
        albums = ['Nơi này có anh', 'Bỏ em vào balo', 'Electro Boy', 'Home', 'Proxy (Original Mix)'],
        trackNames = ['Sơn Tùng MTP', 'Tân Trần', 'Kaaze - Electro Boy', 'Jordan Schor - Home', 'Martin Garrix - Proxy'],
        albumArtworks = ['_1', '_2', '_3', '_4', '_5'],
        trackUrl = ['./Musics/noi_nay_co_anh.mp3', './Musics/Bo_em_vao_balo.mp3', '', '', '', '', ],
