$(function() {
    var playerTrack = $("#player-track"),
        ...
        buffInterval = null,
        tFlag = false,
        albums = ['Nơi này có anh', 'Bỏ em vào balo', 'Sai cách yêu', 'Home', 'Proxy (Original Mix)'],
        trackNames = ['Sơn Tùng MTP', 'Tân Trần', 'Lê Bảo Bình', 'Jordan Schor - Home', 'Martin Garrix - Proxy'],
