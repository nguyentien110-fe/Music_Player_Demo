$(function() {
    ...
    var playerTrack = $("#player-track"),
        ...
        tTime = $('#track-length'),
        tFlag = false,
        albums = ['Nơi này có anh', 'Bỏ em vào balo', 'Sai cách yêu', 'Một bước yêu vạn dặm đau', 'Nắm lấy tay anh', 'BIGCITYBOI', 'Chuyện của mùa đông'],
        trackNames = ['Sơn Tùng MTP', 'Tân Trần', 'Lê Bảo Bình', 'Mr.Siro', 'Tuấn Hưng', 'TOULIVER x BINZ', 'Bùi Anh Tuấn'],
        albumArtworks = ['1', '2', '3', '4', '5', '6', '7'],
        trackUrl = ['./Musics/song1.mp3', './Musics/song2.mp3', './Musics/song3.mp3', './Musics/song4.mp3', './Musics/song5.mp3', './Musics/song6.mp3', './Musics/song7.mp3'],
    ...
    var songs = [
        ...
        },
        {
            ...
            url: "./Musics/song7.mp3",
            picture: "./img/pic7.jpg"
        }
    ];
